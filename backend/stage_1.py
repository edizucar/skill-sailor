...
SYS_PROMPT = "You are a careers advisor and recommend the best labour market sectors for people based on the education, experience, and skills in their profile. You do not add any comments. The profile will be contained in triple angle braces."
BASE_PROMPT = "Suggest the top three different labour market sectors where the person with the following profile could find a job. Return only the names of the sectors without further comments in the format of a python list, for example: ['Sector 1', 'Sector 2', 'Sector 3'].\n"
...
def getIndustries(profile, responseCount):
    """
